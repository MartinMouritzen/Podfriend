	...
	render() {
		...
		if (this.props.episodes && this.props.episodes.length > 0) {
			for(var i=0;i<this.props.episodes.length;i++) {
				if (this.props.episodes[i].season) {
					if (!seasons[this.props.episodes[i].season]) {
						seasons[this.props.episodes[i].season] = {
							seasonNumber: this.props.episodes[i].season,
							episodes: 0,
				...
				if (this.props.episodes[i].listened) {
					episodesListened++;
					if (seasons[this.props.episodes[i].season]) {
						seasons[this.props.episodes[i].season].listenedEpisodes++;
						seasons[this.props.episodes[i].season].episodes++;
					}
				}
				else {
					if (seasons[this.props.episodes[i].season]) {
						seasons[this.props.episodes[i].season].unlistenedEpisodes++;
						seasons[this.props.episodes[i].season].episodes++;
					}
				}
			}
		...
		return (
			<div className={styles.episodeList}>
				...
				/>
				{ this.props.episodes && this.props.episodes.length == episodesListened &&
